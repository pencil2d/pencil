...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ColorBox_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 48, 13)
    ...
    "ColorBox\0colorChanged\0\0setColor\0"
    "onSpinboxChange\0onWheelChange\0"
};
...
void ColorBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->onSpinboxChange((*reinterpret_cast< const QColor(*)>(_a[1]))); break;
        case 3: _t->onWheelChange((*reinterpret_cast< const QColor(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (ColorBox::*_t)(const QColor & );
...
const QMetaObject ColorBox::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ColorBox.data,
      qt_meta_data_ColorBox,  qt_static_metacall, 0, 0}
};
...
// SIGNAL 0
void ColorBox::colorChanged(const QColor & _t1)
{
