...
#include "interface/basedockwidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_BaseDockWidget_t, stringdata) + ofs \
...
const QMetaObject BaseDockWidget::staticMetaObject = {
    { &QDockWidget::staticMetaObject, qt_meta_stringdata_BaseDockWidget.data,
      qt_meta_data_BaseDockWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_BaseDockWidget.stringdata))
