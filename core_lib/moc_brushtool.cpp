...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_BrushTool_t, stringdata) + ofs \
...
const QMetaObject BrushTool::staticMetaObject = {
    { &StrokeTool::staticMetaObject, qt_meta_stringdata_BrushTool.data,
      qt_meta_data_BrushTool,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_BrushTool.stringdata))
