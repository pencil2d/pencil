...
#include "structure/layersound.h"
...
struct qt_meta_stringdata_LayerSound_t {
    QByteArrayData data[1];
    char stringdata[12];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_LayerSound_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_LayerSound_t qt_meta_stringdata_LayerSound = {
    {
...
void LayerSound::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObject LayerSound::staticMetaObject = {
    { &LayerImage::staticMetaObject, qt_meta_stringdata_LayerSound.data,
      qt_meta_data_LayerSound,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_LayerSound.stringdata))
