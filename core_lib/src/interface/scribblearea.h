...
public:
    ...
    void snappingDrawBrush(QPointF origin, QPointF currentPoint, qreal brushStep, qreal brushWidth,  qreal offset, QColor fillColor, QPainter::CompositionMode compMode, qreal opacity, bool usingFeather = true, bool useAA = false);
