                       ...
                       bool selected, LayerVisibility layerVisibility) const
{
    ...
    if (layer->type() == Layer::BITMAP) painter.drawPixmap(QPoint(22, y + 2), QPixmap(":icons/themes/playful/timeline/cell-bitmap.svg"));
    if (layer->type() == Layer::VECTOR) painter.drawPixmap(QPoint(22, y + 2), QPixmap(":icons/themes/playful/timeline/cell-vector.svg"));
    if (layer->type() == Layer::SOUND) painter.drawPixmap(QPoint(22, y + 2), QPixmap(":icons/themes/playful/timeline/cell-sound.svg"));
    if (layer->type() == Layer::CAMERA) painter.drawPixmap(QPoint(22, y + 2), QPixmap(":icons/themes/playful/timeline/cell-camera.svg"));
