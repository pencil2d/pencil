...
VectorBucketTool::VectorBucketTool(QObject* parent) : StrokeTool(parent)
{
}

void VectorBucketTool::loadSettings()
{
...
void VectorBucketTool::resetToDefault()
{
    setWidth(4.0);
    setTolerance(32.0);
}

QCursor VectorBucketTool::cursor()
{
...
/**
 * @brief VectorBucketTool::setWidth
 * @param width
 * set fill thickness
 */
void VectorBucketTool::setWidth(const qreal width)
{
...
void VectorBucketTool::setTolerance(const int tolerance)
{
    // Set current property
...
void VectorBucketTool::pointerPressEvent(PointerEvent* event)
{
    startStroke();
...
void VectorBucketTool::pointerMoveEvent(PointerEvent* event)
{
...
void VectorBucketTool::pointerReleaseEvent(PointerEvent* event)
{
...
void VectorBucketTool::paintStroke(Layer* layer)
{
...
void VectorBucketTool::applyChanges()
{
    mScribbleArea->applyTransformedSelection();
}

void VectorBucketTool::drawStroke()
{
