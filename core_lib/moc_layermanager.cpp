...
#include "managers/layermanager.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_LayerManager_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 39, 19)
    ...
    "LayerManager\0currentKeyFrameChanged\0"
    "\0n\0currentLayerChanged\0"
};
...
void LayerManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->currentKeyFrameChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->currentLayerChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (LayerManager::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LayerManager::currentKeyFrameChanged)) {
                *result = 0;
            }
        }
        {
            typedef void (LayerManager::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LayerManager::currentLayerChanged)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject LayerManager::staticMetaObject = {
    { &BaseManager::staticMetaObject, qt_meta_stringdata_LayerManager.data,
      qt_meta_data_LayerManager,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_LayerManager.stringdata))
...
// SIGNAL 0
void LayerManager::currentKeyFrameChanged(int _t1)
{
...
// SIGNAL 1
void LayerManager::currentLayerChanged(int _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
