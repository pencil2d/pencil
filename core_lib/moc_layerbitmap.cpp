...
#include "structure/layerbitmap.h"
...
struct qt_meta_stringdata_LayerBitmap_t {
    QByteArrayData data[1];
    char stringdata[13];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_LayerBitmap_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_LayerBitmap_t qt_meta_stringdata_LayerBitmap = {
    {
...
void LayerBitmap::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObject LayerBitmap::staticMetaObject = {
    { &LayerImage::staticMetaObject, qt_meta_stringdata_LayerBitmap.data,
      qt_meta_data_LayerBitmap,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_LayerBitmap.stringdata))
