...
static QString getHumanReadableShortcutName(const QString& cmdName)
{
    static QHash<QString, QString> humanReadableShortcutNames = QHash<QString, QString>{
        ...
        {CMD_SELECTION_ADD_FRAME_EXPOSURE, QObject::tr("Selection: Add Frame Exposure", "Shortcut")},
        {CMD_SELECTION_SUBTRACT_FRAME_EXPOSURE, QObject::tr("Selection: Subtract Frame Exposure", "Shortcut")},
        {CMD_REVERSE_SELECTED_FRAMES, QObject::tr("Selection: Reverse Keyframes", "Shortcut")},
        {CMD_REMOVE_SELECTED_FRAMES, QObject::tr("Selection: Remove Keyframes", "Shortcut")},
