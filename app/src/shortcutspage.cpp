...
static QString getHumanReadableShortcutName(const QString& cmdName)
{
    static QHash<QString, QString> humanReadableShortcutNames = QHash<QString, QString>{
        ...
        {CMD_INCREASE_FRAME_EXPOSURE, QObject::tr("Increase frame exposure", "Shortcut")},
        {CMD_DECREASE_FRAME_EXPOSURE, QObject::tr("Decrease frame exposure", "Shortcut")},
        {CMD_REVERSE_SELECTED_FRAMES, QObject::tr("Reverse selected Keyframes", "Shortcut")},
        {CMD_REMOVE_SELECTED_FRAMES, QObject::tr("Remove selected Keyframes", "Shortcut")},
