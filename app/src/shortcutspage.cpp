...
static QString getHumanReadableShortcutName(const QString& cmdName)
{
    static QHash<QString, QString> humanReadableShortcutNames = QHash<QString, QString>{
        ...
        {CMD_DISPLAY_FLIP_HORIZONTAL, ShortcutsPage::tr("Display: Horizontal Flip", "Shortcut")},
        {CMD_DISPLAY_FLIP_VERTICAL, ShortcutsPage::tr("Display: Vertical Flip", "Shortcut")},
