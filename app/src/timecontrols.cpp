...
void TimeControls::initUI()
{
    ...
    mTimecodeSelect->setIconSize(QSize(22,22));
    mTimecodeSelect->setIcon(QIcon(":/icons/themes/playful/controls/control-timecode.svg"));
    ...
    layout()->addWidget(mTimecodeSelect);
